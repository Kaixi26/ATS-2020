...
/* package logGenerator-0.1.0.0 */
#ifndef VERSION_logGenerator
#define VERSION_logGenerator "0.1.0.0"
#endif /* VERSION_logGenerator */
#ifndef MIN_VERSION_logGenerator
#define MIN_VERSION_logGenerator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_logGenerator */
...
#define CURRENT_COMPONENT_ID "logGenerator-0.1.0.0-6s6eBTxcTxN1jEOXfaq7Ox-logGenerator"
