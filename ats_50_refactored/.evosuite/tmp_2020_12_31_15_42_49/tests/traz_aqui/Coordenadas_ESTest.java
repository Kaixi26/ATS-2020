...
public class Coordenadas_ESTest extends Coordenadas_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      double double0 = coordenadas0.getY();
      assertEquals((-1.0), coordenadas0.getX(), 0.01);
  ...
  public void test06()  throws Throwable  {
      Coordenadas coordenadas0 = new Coordenadas((-801.0), 0.0);
      Coordenadas coordenadas1 = coordenadas0.clone();
      assertEquals((-801.0), coordenadas0.getX(), 0.01);
      assertEquals((-801.0), coordenadas1.getX(), 0.01);
      assertEquals(0.0, coordenadas0.getY(), 0.01);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Coordenadas coordenadas1 = coordenadas0.clone();
      assertEquals(2.0, coordenadas1.getY(), 0.01);
      assertEquals(2.0, coordenadas0.getX(), 0.01);
      assertEquals(2.0, coordenadas1.getX(), 0.01);
  ...
  public void test16()  throws Throwable  {
      Coordenadas coordenadas0 = new Coordenadas((-1200.430608296416), 987.0);
      boolean boolean0 = coordenadas0.isRange(coordenadas0, (-1200.430608296416));
      assertEquals(987.0, coordenadas0.getY(), 0.01);
      assertEquals((-1200.430608296416), coordenadas0.getX(), 0.01);
  ...
  public void test17()  throws Throwable  {
      ...
      assertEquals("X: -1200.430608296416- Y:987.0", string0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      coordenadas0.setX(987.0);
      assertEquals(987.0, coordenadas0.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      Coordenadas coordenadas0 = new Coordenadas((-1200.430608296416), 987.0);
      coordenadas0.setY(987.0);
      assertEquals((-1200.430608296416), coordenadas0.getX(), 0.01);
      assertEquals(987.0, coordenadas0.getY(), 0.01);
  }
  ...
  public void test20()  throws Throwable  {
      Coordenadas coordenadas0 = new Coordenadas((-1200.430608296416), 987.0);
      boolean boolean0 = coordenadas0.isRange(coordenadas0, 987.0);
      assertEquals((-1200.430608296416), coordenadas0.getX(), 0.01);
      assertTrue(boolean0);
      assertEquals(987.0, coordenadas0.getY(), 0.01);
  }
