...
public class Historico_ESTest extends Historico_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      List<Registos> list0 = historico0.empHist("", 5);
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        historico0.adicionaReg(2074, (Registos) null);
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals((-3165.8836143), registos0.getCustoT(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      Historico historico0 = new Historico();
      Encomenda encomenda0 = new Encomenda((String) null, "1~C|8v;hMCltPyKj1U", "", 0L);
      Month month0 = Month.FEBRUARY;
      LocalDateTime localDateTime0 = MockLocalDateTime.of(1, month0, 1, 0, 1, 1);
      Double double0 = new Double(0.0);
      Registos registos0 = new Registos(encomenda0, localDateTime0, "v", "", double0, double0, double0);
      historico0.adicionaReg(1, registos0);
      Registos registos1 = historico0.done((String) null, (-272.18869074));
      assertEquals((-272.18869074), registos1.getTmp(), 0.01);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      assertEquals(4.0, registos0.getCustoT(), 0.01);
  }
  ...
  public void test21()  throws Throwable  {
      Historico historico0 = new Historico();
      List<Registos> list0 = historico0.lojaHist("-&}7Q:]n;9`F[>KtP-", 4);
      assertEquals(0, list0.size());
  }
  ...
  public void test23()  throws Throwable  {
      Historico historico0 = new Historico();
      List<Registos> list0 = historico0.lojaHist("p6!t>P", 1);
      assertEquals(0, list0.size());
  }
  ...
  public void test24()  throws Throwable  {
      Historico historico0 = new Historico();
      List<Registos> list0 = historico0.lojaHist("", 432);
      assertEquals(0, list0.size());
  }
  ...
  public void test25()  throws Throwable  {
      Historico historico0 = new Historico();
      List<Registos> list0 = historico0.userHist("`", 4);
      assertEquals(0, list0.size());
  }
  ...
  public void test26()  throws Throwable  {
      Historico historico0 = new Historico();
      List<Registos> list0 = historico0.userHist((String) null, 432);
      assertTrue(list0.isEmpty());
  }
  ...
  public void test27()  throws Throwable  {
      Historico historico0 = new Historico();
      List<Registos> list0 = historico0.userHist("KCJ5K0!Iyo^~Ub", 3);
      assertEquals(0, list0.size());
  }
  ...
  public void test28()  throws Throwable  {
      Historico historico0 = new Historico();
      List<Registos> list0 = historico0.userHist("Quantidade: ", 1);
      assertTrue(list0.isEmpty());
  }
  ...
  public void test29()  throws Throwable  {
      Historico historico0 = new Historico();
      List<Registos> list0 = historico0.empHist("`", 4);
      assertEquals(0, list0.size());
  }
  ...
  public void test30()  throws Throwable  {
      Historico historico0 = new Historico();
      List<Registos> list0 = historico0.empHist("KCJ5K0!Iyo^~Ub", 3);
      assertEquals(0, list0.size());
  }
  ...
  public void test33()  throws Throwable  {
      Historico historico0 = new Historico();
      List<Registos> list0 = historico0.volHist("-&}7Q:]n;9`F[>KtP-", 4);
      assertEquals(0, list0.size());
  }
  ...
  public void test34()  throws Throwable  {
      Historico historico0 = new Historico();
      List<Registos> list0 = historico0.volHist("KCJ5K0!Iyo^~Ub", 3);
      assertTrue(list0.isEmpty());
  }
  ...
  public void test35()  throws Throwable  {
      Historico historico0 = new Historico();
      List<Registos> list0 = historico0.volHist("Quantidade: ", 1);
      assertTrue(list0.isEmpty());
  }
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        historico0.removeReg(3, (Registos) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      ...
      Double double0 = new Double(1);
      Registos registos0 = new Registos(encomenda0, localDateTime0, "(", "(", double0, double0, double0);
      Registos registos1 = historico0.removeReg(0, registos0);
      assertNull(registos1);
  }
  ...
  public void test43()  throws Throwable  {
      Historico historico0 = new Historico();
      Encomenda encomenda0 = new Encomenda("KCJ5K0!Iyo^~Ub", "KCJ5K0!Iyo^~Ub", "KCJ5K0!Iyo^~Ub", 3);
      LinkedList<StringDistAux> linkedList0 = new LinkedList<StringDistAux>();
      StringDistAux stringDistAux0 = new StringDistAux(3, "KCJ5K0!Iyo^~Ub");
      linkedList0.add(stringDistAux0);
      int int0 = historico0.gestaoEncomenda(encomenda0, "KCJ5K0!Iyo^~Ub", linkedList0);
      assertFalse(linkedList0.contains(stringDistAux0));
      assertEquals(1, int0);
  }
  ...
  public void test47()  throws Throwable  {
      Historico historico0 = new Historico();
      historico0.removeFila("KCJ5K0!Iyo^~Ub");
  }
}
